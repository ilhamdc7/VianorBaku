...
const Product = ({tire}) => {
  return (
    <div class="block-products-carousel__column" id="card-hover">
              ...
              >
                <div style={{"height": "40px","backgroundColor": "#fff","justifyContent": "center","color": "#000","display": "flex", "alignItems": "center","textAlign": "center","fontSize": "14px","alignItems": "center"}}>
                  {" "}
                </div>
                  ...
                  <div class="d-flex " style={{"justifyContent":"space-between;"}}>
                    ...
                    >
                      ...
                      <div style={{"display": "flex"}}>
                        ...
                        <span
                          id="change_count"
                          class="mr-2 ml-2 count_change_span"
                        >
                          1
                        </span>
