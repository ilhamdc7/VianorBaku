                    ...
                    <div class="container container--max--xl">
                      <ul class="block-brands__list border-0 m-0 p-0">
                        <input
                          ...
                          value="4voA5Bkl5MgLFqT3rQl5llOo43k4GRdT8ORXiEdxrFq5mp2xPEg9yB5OlsgHGFui"
                        />

                        {markas?.map((marka) => (
                          <li
                            class="block-brands__item brand d-flex flex-column"
                            style={{ cursor: "pointer" }}
                          >
                            <Link
                              href={`/search?brand=${marka?.title}`}
                              class="block-brands__item-link mb-0 pb-0"
                            >
                              <img
                                class="neeeded"
