  ...
  return (
    <div class="site__body">
      ...
      <div className="w-100 d-flex" >
        <div class="sidebar sidebar--offcanvas--mobile" style={{marginLeft:'3%', width:'15%'}}>
        ...
        <div className="d-block" style={{marginLeft:'5%', width:'85%'}}>
            <div class="products-view__options view-options view-options--offcanvas--mobile">
                      <div class="view-options__body">
                       ...
                       <div className="w-75">
                        ...
                        <select onChange={(e) => getSelectedWidthData(e.target.value)} className="w-15" style={{marginLeft:'30%', height:'40px'}}>
                        ...
                        <select className="w-15" style={{marginLeft:'1%', height:'40px'}}>
                        ...
                        <button style={{width:'100px', height:'40px',marginLeft:'40px', backgroundColor:'#f25900',color:'white',borderRadius:'10px', borderStyle:'none'}}>
                            Axtar
                        </button>
                        <select className="w-15" style={{marginLeft:'1%', height:'40px'}}>
            ...
            <div className="d-flex flex-wrap" style={{ width:'100%', justifyContent:'center'}}>
                {tyres?.map((tyre) => (
                    <Product tire={tyre}/>
